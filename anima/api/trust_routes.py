...
router = APIRouter()
log = logging.getLogger("anima.api.trust")
...
_TOOL_LEVEL_MAP: list[dict] = [
    ...
    {"name": "git_branch",    "level_required": 2,
     "description": "Create a anima/* branch in the project repo (autonomous commits stay isolated)"},
    {"name": "git_commit",    "level_required": 2,
     "description": "Stage all changes and commit to current anima/* branch (refuses main/master)"},
