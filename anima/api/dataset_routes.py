...
log = logging.getLogger("anima.api.dataset")
...
def dataset_examples(
    ...
    from anima.dataset.manager import list_examples
    from anima.dataset.schema import VALID_DOMAINS
...
def dataset_export(user: User = Depends(current_user)) -> FileResponse:
    ...
    from anima.dataset.manager import export_jsonl
