...
from anima.kernel import billing_context, llm_client
from anima.kernel.tools import TOOL_DEFINITIONS, execute as execute_tool

log = logging.getLogger("anima.agent_loop")
...
_SYSTEM_PROMPT = """You are Anima — an AI operating system with real execution capabilities.
