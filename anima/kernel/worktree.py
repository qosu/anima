...
log = logging.getLogger("anima.kernel.worktree")
...
async def create_worktree(repo_path: str) -> str | None:
    ...
    tree has some branch (possibly a stale anima/* branch) checked out —
    git_branch creates a fresh anima/* branch from this detached HEAD.
