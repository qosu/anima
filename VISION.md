...
## The question Anima is trying to answer
...
Anima is an attempt to answer that question differently: the AI owns the computer.
...
Anima pursues the second path. The safety floors are not guards around the AI. They are invariants the AI holds about itself.

## The safety doctrine

The hardest design decision in Anima is this: **zero-lockout beats tamper-resistance.**
...
**Multi-host substrate.** Anima currently owns one machine. An AI entity that can own a cluster — maintaining coherent policy across machines, with distributed audit chain and cross-node deadman — is a harder problem and a more useful one.
...
Anima is not a general-purpose AI agent framework. It does not abstract away the substrate. The point is that the substrate is visible and owned by the entity that runs on it.
