...
class TestMemoryIndex:
    ...
    def setup_method(self):
        ...
        from anima.kernel import memory_index as mi
...
class TestContextBuilder:
    ...
    def test_recent_messages_in_order(self):
        import anima.db as db
        from anima.models import Memory, MemoryTier, MessageRole
    ...
    def test_continuity_block_includes_self_narrative_at_top(self):
        import json
        import anima.db as db
        with db._conn() as conn:
            conn.execute(
                """INSERT INTO user_model
                   (user_id, inferred_goal, goal_confidence, goal_domain, active_domains, recent_activity, self_narrative)
                   VALUES (?, ?, ?, ?, ?, ?, ?)""",
                (self.user.id, "Ship the checkout flow", 0.82, "feature",
                 json.dumps(["feature", "api"]), json.dumps([]),
    ...
    def test_merge_dynamic_context_prepends_to_last_message(self):
        from anima.kernel.context_builder import merge_dynamic_context
...
class TestSummarizer:
    ...
    def test_returns_string(self):
        ...
        import anima.db as db
        import hashlib
        from anima.models import User, Project, Memory, MemoryTier, MessageRole
